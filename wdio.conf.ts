...
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        'appium:deviceName': 'emulator-5554', // El ID que vimos antes
        'appium:platformVersion': '16.0',    // Ajustado a tu emulador actual
        'appium:automationName': 'UiAutomator2',
        'appium:app': './test/assets/mda-2.2.0-25.apk', // Ruta al APK
        'appium:newCommandTimeout': 30000,
        'appium:noReset': false // Reinstala el app en cada ejecución (limpio)
    }],
